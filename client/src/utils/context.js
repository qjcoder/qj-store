...
This means that the props can be accessed from any component.
Therefore, no need to pass props through other components to send it at the end to our destination component.
